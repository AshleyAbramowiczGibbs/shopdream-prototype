...
Style.create!(image_url: "https://www.gap.com/webcontent/0014/585/394/cn14585394.jpg", user_id: 1)
Style.create!(image_url: "https://fanatics.frgimages.com/FFImage/thumb.aspx?i=/productimages/_2659000/altimages/ff_2659847alt1_full.jpg&w=900", user_id: 1)
Style.create!(image_url: "https://slimages.macysassets.com/is/image/MCY/products/0/optimized/10008500_fpx.tif?op_sharpen=1&wid=500&hei=613&fit=fit,1&$filtersm$", user_id: 1)
Style.create!(image_url: "https://slimages.macysassets.com/is/image/MCY/products/7/optimized/8689127_fpx.tif?op_sharpen=1&wid=500&hei=613&fit=fit,1&$filtersm$", user_id: 1)
Style.create!(image_url: "https://n.nordstrommedia.com/id/160bec7f-27d3-4e1e-a6c2-605d11be879b.jpeg?crop=pad&pad_color=FFF&format=jpeg&w=780&h=1196&quality=70", user_id: 1)


ItemTag.create!(user_id: 1, style_id: 1, name: "stripped orange and pink sweater")
ItemTag.create!(user_id: 1, style_id: 1, name: "grey high waisted jeans")
ItemTag.create!(user_id: 1, style_id: 2, name: "navy midi dress")
ItemTag.create!(user_id: 1, style_id: 2, name: "nude sandals")
ItemTag.create!(user_id: 1, style_id: 2, name: "cat eye sunglasses")
ItemTag.create!(user_id: 1, style_id: 3, name: "navy tshirt dress")
ItemTag.create!(user_id: 1, style_id: 5, name: "black winter coat")
ItemTag.create!(user_id: 1, style_id: 6, name: "Black lace dress")
